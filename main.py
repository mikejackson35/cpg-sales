...
direct_sales_bar_df = round(direct_sales[(direct_sales.index>'2024-11-30') & (direct_sales.index<'2024-12-31')].groupby('date')['amount'].sum(),2).reset_index().set_index('date')
